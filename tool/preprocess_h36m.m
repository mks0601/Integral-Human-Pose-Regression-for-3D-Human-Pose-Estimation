...
function preprocess_h36m()
    ...
    num_joint = 17;
    root_dir = 'SET_YOUR_OUTPUT_DIRECTORY'; %you have to set your output directory
        ...
        for action = ACTION
            for subaction = SUBACTION
                for camera = CAMERA
                    ...
                    save_dir = sprintf('%s/s_%02d_act_%02d_subact_%02d_ca_%02d', ...
                    ...
                    for i = 1:num_frame
                        ...
                        img_name = sprintf('%s/s_%02d_act_%02d_subact_%02d_ca_%02d_%06d.jpg', ...
                            save_dir, subject, action, subaction, camera, i);
                    ...
                    filename = sprintf('%s/h36m_meta.mat', save_dir);
